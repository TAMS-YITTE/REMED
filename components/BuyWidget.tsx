...
export function BuyWidget({ crypto = 'eth' }: BuyWidgetProps) {
  ...
  if (!activeWalletAddress) {
    return (
      <div className="flex flex-col items-center justify-center w-full h-[600px] bg-[#25274A] border border-white/10 rounded-xl text-center p-6">
  ...
  return (
    <div>
      ...
      <details className="mt-6 group">
        ...
        <div className="mt-4 p-4 bg-[#25274A] rounded-xl border border-indigo-500/30 flex flex-col sm:flex-row items-center justify-between gap-4 relative z-0">
          ...
          <button
            ...
            className="w-full sm:w-auto whitespace-nowrap px-4 py-2 bg-[#1B1C3E] border border-indigo-500/50 hover:bg-indigo-500/20 text-indigo-300 text-sm font-medium rounded-lg transition-colors shadow-sm"
          >
