...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1B1C3E] border-t border-white/10 py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#25274A] border border-white/10 rounded-xl p-5 mb-8 text-[11px] leading-relaxed text-gray-400">
